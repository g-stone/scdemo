...
package com.stone.commons.tools.cbc.crypto;

import java.security.Provider;

public final class ABAProvider extends Provider {
	public final static String PV_NAME = "CCB";
    ...
    public ABAProvider()
    {
        super(PV_NAME, 1.1D, info);
        put("MessageDigest.MD5", "com.stone.commons.tools.cbc.crypto.MD5");
        ...
        put("Cipher.RSA", "com.stone.commons.tools.cbc.crypto.RSA");
        ...
        put("KeyPairGenerator.RSA", "com.stone.commons.tools.cbc.crypto.RSAKeyPairGenerator");
        ...
        put("KeyFactory.RSA", "com.stone.commons.tools.cbc.crypto.RSAKeyFactory");
        ...
        put("Signature.MD5withRSA", "com.stone.commons.tools.cbc.crypto.MD5withRSA");
