...
public class CBCSignTest {
	public static void main(String []args){
		...
		if( rsa.verifySigature(strSign,strSrc)){
			System.out.println("one\t Sign OK");
		} else {
			System.out.println("one\t Sign fail");
		}
		...
		if( rsa.verifySigature(strSign,strSrc) ){
			System.out.println("two\t Sign OK");
		}
		else{
			System.out.println("two\t Sign failed");
		}
		...
		System.out.println(strSign);
		if( rsa.verifySigature( strSign,strSrc) ){
			System.out.println("three\t Sign OK");
		} else {
			System.out.println("three\t Sign failed");
		}
		...
		rsa.setPublicKey( strPubKey);
		if( rsa.verifySigature( strSign,strSrc) ){
			System.out.println("four\t Sign ok");
		} else {
			System.out.println("four\t Sign failed");
		}
		...
		rsa.setPublicKey(strPubKey);
		if( rsa.verifySigature( strSign,strSrc) ){
			System.out.println("five\t Sign OK");
		} else {
			System.out.println("five\t Sign failed");
		}
		...
		rsa.setPublicKey(strPubKey);
		if( rsa.verifySigature( strSign,strSrc) ){
			System.out.println("six\t Sign OK");
		} else {
			System.out.println("six\t Sign failed");
		}
		...
		rsa.setPublicKey(strPubKey);
		if( rsa.verifySigature( strSign,strSrc) ){
			System.out.println("seven\t Sign OK");
		} else {
			System.out.println("seven\t Sign failed");
		}
		...
		rsa.setPublicKey(strPubKey);
		if( rsa.verifySigature( strSign,strSrc) ){
			System.out.println("eight\t Sign OK");
		} else {
			System.out.println("eight\t Sign failed");
		}
	}
}
/**
 * 
 * 
 * 
 * 
 */
